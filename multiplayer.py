...
seccion_y2 = 230 + ky
seccion = [
    (seccion_y1, 130 + kx, seccion_y2, 172 + kx),   # 117 0 = Verde
    (seccion_y1, 173 + kx, seccion_y2, 228 + kx),   # 1 = Rojo
    (seccion_y1, 231 + kx, seccion_y2, 286 + kx),   # 2 = Amarillo
    (seccion_y1, 288 + kx, seccion_y2, 347 + kx),   # 3 = Azul
    (seccion_y1, 348 + kx, seccion_y2, 390 + kx),   # 404 4 = Naranja
]
